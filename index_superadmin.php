...
<body>
    <div class="banner">
        ...
        <div class="login-container">
            <p class="login"><a href="php/logout.php">Salir</a></p>
        </div>
    </div>
    <div class="boton2">
        <button class="btn2" onclick="location.href='php/mod_info.php'">Editar información</button>
            ...
            foreach ($tickets as $ticket) {
                ...
                <div class="lista">
                    <div class="item item-1">
                        <p><a href="reporte_mod.php?folio=<?php echo $ticket['folio']; ?>">
