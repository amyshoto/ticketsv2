...
<body>
    ...
    <form id="form_reporte" action="reporte_canbd.php" method="post" class="container" onload="limpiarFormulario()">
    <?php 
    ...
    ?>
        ...
        <?php
            ...
            //     $query = "UPDATE ticket SET estado='$estado' AND solucionCancelacion='$cancelacion' WHERE folio='$folio1'";
